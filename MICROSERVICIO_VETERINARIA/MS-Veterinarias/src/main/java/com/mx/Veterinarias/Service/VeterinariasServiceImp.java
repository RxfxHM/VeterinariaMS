...
public class VeterinariasServiceImp implements IVeterinariasService{
	...
	public List<Mascotas> getTodosMascotas() {
		ResponseEntity<List<Mascotas>> list = restTemplate.exchange("http://localhost:8003/mascotas/listar",
				HttpMethod.GET,
				null,
	...
	public Mascotas saveMascota(Mascotas mascota) {
		ResponseEntity<Mascotas> masco = restTemplate.postForEntity("http://localhost:8003/mascotas/guardar", 
											mascota, Mascotas.class);
		return masco.getBody();
	}
	...
	public List<Clientes> getTodosClientes() {
		ResponseEntity<List<Clientes>> list = restTemplate.exchange("http://localhost:8004/clientes/listar",
				HttpMethod.GET,
				null,
	...
	public Clientes editClient(Clientes cliente) {
		ResponseEntity<Clientes> editclient = restTemplate.exchange("http://localhost:8004/clientes/editar", 
				HttpMethod.PUT, 
		        new HttpEntity<>(cliente), 
		        Clientes.class
		    );
		return editclient.getBody();
	}
	...
	public Map<String, Object> obtenerTodosLosModulos(Long veterinariaId){
