...
public class ClientesWS {
	...
	@PostMapping("/guardar")
	@Operation(summary = "EndPoint para guardar un Objeto Cliente", description = "Recibe un Objeto cliente que guardar en la base datos")
	public ResponseEntity<?> guardar(@RequestBody Clientes cliente) {
		if (service.validacion(cliente.getNombre(), cliente.getDireccion())) {
	...
	@GetMapping("/listar")
	@Operation(summary = "EndPoint para listar Clientes", description = "Obtiene toda la informacion de los Clientes y los devuelve en una lista")
	...
	@PutMapping("/editar")
	@Operation(summary = "EndPoint para editar un Objeto Cliente", description = "Recibe un objeto Cliente y modifica sus valores en base de datos")
	...
	@Operation(summary = "EndPoint para eliminar un Objeto Cliente", description = "Recibe un ID cliente y lo elimina de la base de datos")
	...
	@Operation(summary = "EndPoint para buscar un Objeto Cliente", description = "Recibe un ID de Cliente y obtiene todos los valores de ese cliente de la base de datos")
	...
	@Operation(summary = "EndPoint RestTemplate para buscar todas las Mascotas por Cliente", description = "Recibe un Objeto Cliente y devuelve todas las Mascotas del Cliente en forma de Lista")
